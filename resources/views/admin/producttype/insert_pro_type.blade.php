            ...
            <div class="panel panel-default"><!-- panel panel-default begin -->
                <div class="panel-heading"><!-- panel-heading begin -->
                    <h3 class="panel-title" style="padding:10px"><!-- panel-title begin -->
                        ...
                        <font style="font-size:20px" ><b> <i class="fa fa-tags fa-fw"></i> THÊM DANH MỤC </b> </font>
                    ...
                    <form method="post" action="{{url('admin/insert_p_type')}}" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal begin -->
                        ...
                        <div class="form-group"><!-- form-group begin -->
                            ...
                            <div class="col-md-6"><!-- col-md-6 begin -->
                                ...
                                <input value="Thêm danh mục" name="submit" type="submit" class="form-control btn btn-primary">
