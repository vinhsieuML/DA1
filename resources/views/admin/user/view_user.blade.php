        ...
        <div class="col-lg-12"><!-- col-lg-12 begin -->
                ...
                <div class="panel-heading"><!-- panel-heading begin -->
                        <h3 class="panel-title" style="padding:10px"><!-- panel-title begin -->
                            ...
                            <font style="font-size:20px" ><b> <i class="fa fa-tags fa-fw"></i> DANH SÁCH KHÁCH HÀNG </b> </font>
...
$(document).ready(function(){
 ...
 function fetch_data(page, sort_type, sort_by, query)
 {
  ...
  $.ajax({
   url:"view_user/fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&query="+query,
   method:"POST",
