<div class="panel panel-default sidebar-menu">
    ...
    <div class="panel-body">
        ...
        <ul class="nav-pills nav-stacked nav">
            ...
            <li class="<?php if (strpos(url()->current(), 'orders')) {
                            echo "active";
                        } ?>">
            ...
            <li class="<?php if (strpos(url()->current(), 'accountInfo')) {
                            echo "active";
                        } ?>">

                    <a href="{{url('user/accountInfo')}}">
            ...
            <li class="<?php if (strpos(url()->current(), 'changePass')) {
                                echo "active";
                            } ?>">
